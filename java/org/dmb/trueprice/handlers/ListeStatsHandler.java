 ...
 * @author Guitch
 */
public class ListeStatsHandler extends BasicHandler {
    
    private static final Logger log = InitContextListener.getLogger(ListeStatsHandler.class) ;    
    ...
    public ListeStatsHandler(ListesInfoJpaController infoManager, ListesResultJpaController resultManager, ListesStatsJpaController statsManager, ListesJpaController baseManager) {
...
/*  /////////////////////////  */    
    ...
    public void setErreur( String champ, String message ) {
        log.warn("\n==========\tINSERTING EXCEPTION for {Liste Stats Handler} to [" + champ + "] because > " + message);
